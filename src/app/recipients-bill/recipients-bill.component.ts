import {
  ...
  import { RecipientsBillService } from "../services/recipients-bill-service";
  ...
  import { PublicRecipientsBillReceiptDetailModalComponent } from "./modal/public-recipients-bill-receipt-detail-modal-component/public-recipients-bill-receipt-detail-modal-component.component";
  ...
  @Component({
    selector: "app-recipients-bill",
    templateUrl: "./recipients-bill.component.html",
    styleUrls: ["./recipients-bill.component.css"],
  })
  export class RecipientsBillComponent implements OnInit, OnDestroy {
    ...
    constructor(
      private RecipientsBillService: RecipientsBillService,
    ...
    public handleReprocessBillErrorSubscription(): Subscription {
      return this.RecipientsBillService.reprocessBillError$.subscribe(
        (error: boolean) => {
          if (error) {
            this.openSnackBar(
    ...
    public handleReprocessBillSuccessSubscription(): Subscription {
      return this.RecipientsBillService.reprocessBillSuccess$.subscribe(
        (success: boolean) => {
          if (success) {
    ...
    public handleResedEmailErrorSubscription(): Subscription {
      return this.RecipientsBillService.resendEmailError$.subscribe(
        (error: boolean) => {
          if (error) {
    ...
    public handleResendEmailSuccessSubscription(): Subscription {
      return this.RecipientsBillService.resendEmailSuccess$.subscribe(
        (success: boolean) => {
          if (success) {
   ...
   /* public openDialog(): void {
    ...
    public getStateBill(): void {
      this.RecipientsBillService.getStateBill().subscribe((data) => {
        this.stateList = data;
      });
    }
  
    public getPayMethod(): void {
      this.RecipientsBillService.getPayMethod().subscribe((data) => {
        this.payMethodList = data;
      });
    }
  
    public getSaleCondition(): void {
      this.RecipientsBillService.getSaleCondition().subscribe((data) => {
        this.saleConditionList = data;
      });
    }
  
    public getCartera(): void {
      this.RecipientsBillService.getCartera().subscribe((data) => {
        this.carteraList = data;
      });
    }
  
    public getDocType(): void {
      this.RecipientsBillService.getDocType().subscribe((data) => {
    ...
    public getPdfBill(consecutiveNumber): void {
      this.RecipientsBillService.getPDF(consecutiveNumber).subscribe((data) => {
      ...
      this.RecipientsBillService
        ...
        .subscribe((data) => {
          ...
          const dialogRef = this.dialog.open(
            PublicRecipientsBillReceiptDetailModalComponent,
            {
              width: "500px",
    ...
    public reprocessBill(consecutiveNumber: string): void {
      this.RecipientsBillService.reprocessBill(consecutiveNumber);
    }
  ...
  @Component({
    selector: 'recipients-bill-alert-dialog',
    templateUrl: 'recipients-bill-alert-dialog.html',
  })
  export class RecipientsBillAlertDialog {
  
    constructor(
      public dialogRef: MatDialogRef<RecipientsBillAlertDialog>,
